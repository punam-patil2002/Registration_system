...
def clear():
    ...
    f_Name.set('')
    m_Name.set('')
    Father_Occupiation.set('')
    Mother_Occupiation.set('')
...
def save():
    ...
    F1=Father_Occupiation.get()
    M1=Mother_Occupiation.get()
...
def search():
     ...
     #print(x12)
      ...
      f_Name.set(x9)
      m_Name.set(x10)
      Father_Occupiation.set(x11)
      Mother_Occupiation.set(x12)    
...
#top frames
Label(root,text="Email: patilpunamn20@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Updete_button=Button(root,image=imageicon4,bg="#c36464",command=Update)
Updete_button.place(x=110,y=64)
...
Father_Occupiation=StringVar()
fo_entry = Entry(obj2,textvariable=Father_Occupiation,width=20,font="arial 10")
...
Mother_Occupiation=StringVar()
mo_entry = Entry(obj2,textvariable=Mother_Occupiation,width=20,font="arial 10")
